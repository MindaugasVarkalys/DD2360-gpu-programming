...
const char *mykernel = "__kernel                                                                                                                        \n"
                       ...
                       "    int workgroup_x = get_group_id(0);                                                                                          \n"
                       "    int workgroup_y = get_group_id(1);                                                                                          \n"
                       "    int workgroup_z = get_group_id(2);                                                                                          \n"
                       "    int workitem_x = get_local_id(0);                                                                                           \n"
                       "    int workitem_y = get_local_id(1);                                                                                           \n"
                       "    int workitem_z = get_local_id(2);                                                                                           \n"
                       "    printf(\"Hello world! My global coordinates are (%d, %d, %d). Work group (%d, %d, %d). Work item (%d, %d, %d)\\n\", x, y, z, workgroup_x, workgroup_y, workgroup_z, workitem_x, workgroup_y, workitem_z); \n"
                       "}                                                                                                                               \n";
